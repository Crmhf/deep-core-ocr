...
**核心原则：按场景选模型，复杂场景 MiniMax-M3 兜底。**

## 支持的模型

| 模型 | 能力档位 | 擅长 | 单次成本 | 速度 | 主用场景 |
|------|---------|------|---------|------|---------|
| **DeepSeek-OCR** | ⭐⭐⭐⭐ A 级 | 印刷体文档、规范手写体、票据、表格 | 低 | 快 | 纸质文档数字化 |
| **Qwen2.5-VL** | ⭐⭐⭐⭐ A 级 | 通用识别、中英文混合、截图、界面文字 | 低 | 中 | **日常主力、通用识别** |
| **MiniMax-M3** | ⭐⭐⭐⭐⭐ S 级 | 复杂实景、多语言、小字、自然场景 | 中 | 中 | 复杂图片、兜底 |

### 选型速查

```
纸质文档 / 印刷体 / 票据 → DeepSeek-OCR / Qwen2.5-VL
桌面截图 / 客户端界面 → Qwen2.5-VL
实物影像 / 铭牌 / 标签 → Qwen2.5-VL / MiniMax-M3
